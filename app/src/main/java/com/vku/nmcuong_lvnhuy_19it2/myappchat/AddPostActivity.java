  ...
  private static final int STORAGE_REQUEST_CODE = 200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       actionBar = getSupportActionBar();
        ...
        // validate if we came here to update post came from AdapterPost
...
//            uploadBtn.setText("Upload");
    ...
    private void updateWasWithImage(final String title, final String description, final String editPostId) {
        StorageReference mRef = FirebaseStorage.getInstance().getReferenceFromUrl(editImage);
        mRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
            ...
            case CAMERA_REQUEST_CODE:{
                if (grantResults.length>0) {
                    ...
                    if (cameraAccepted && storageAccepted){
                        ...
                        Toast.makeText(this,"Camera & Storage both...",Toast.LENGTH_SHORT).show();
                    }
                }
                else {
